(function ($) {
	...
	var datepickerOptions = {
		...
		function positionRP(){
			...
			rp.parent().css(side, val).css('top', riOffset.top + relEl.outerHeight() - 200);
		}
		...
		//picker divs
		var rpPickers = $('<div class="ranges ui-widget-header ui-corner-all ui-helper-clearfix"><div class="range-start"></div><div class="range-end"></div></div>').appendTo(rp);
